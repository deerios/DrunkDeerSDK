...
/// </summary>
/// <remarks>
/// Pass to <see cref="KeyboardSession.GetKeyIndex"/>, <see cref="KeyboardSession.SetKeyColor"/>,
/// depth-setter overloads, and <see cref="KeyboardSession.ConfigureLastWinPairs(ValueTuple{DDKey,DDKey}[])"/>
/// to target keys by name rather than raw firmware index.
/// </remarks>
/// <example>
/// <code>
/// // WASD to maximum sensitivity, everything else at 2.0 mm.
/// session.SetActuationPoint(0.2f, DDKey.W, DDKey.A, DDKey.S, DDKey.D);
///
/// // Light Escape red, everything else off.
/// session.SetKeyColor(DDKey.Escape, 255, 0, 0);
/// </code>
/// </example>
public enum DDKey
{
...
/// <summary>Maps each <see cref="DDKey"/> to the token string used in keyboard layout arrays.</summary>
internal static class KeyLayoutNames
{
	internal static readonly IReadOnlyDictionary<DDKey, string> Names =
		new Dictionary<DDKey, string>
		{
			[DDKey.Escape]        = "ESC",
			[DDKey.F1]            = "F1",
			[DDKey.F2]            = "F2",
